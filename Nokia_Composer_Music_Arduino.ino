 ...
 * Thank you Akshay.
 * 
 * http://freehinditones.com/english.html
...
char* elise = "2e2 8e2 8#d2 8e2 8#d2 8e2 8b1 8d2 8c2 4a1 8- 8c1 8e1 8a1 4b1 8- 8e1 8#g1 8b1 4c2 8- 8e1 8e2 8#d2 8e2 8#d2 8e2 8b1 8d2 8c2 4a1 8- 8c1 8e1 8a1 4b1 8- 8e1 8c2 8b1 4a1";
...
void setup() {
  ...
  // playMusic(Pin-No, music string, tempo,frequency factor);
    playMusic(A3,elise,130,3.5);
    delay(500);
    playMusic(A3,cid_moosa,169,3.3);
